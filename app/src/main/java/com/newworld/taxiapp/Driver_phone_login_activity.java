...
public class Driver_phone_login_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.driver_activity_phone_login);
...
//auto phone select api
        ...
        PendingIntent intent = Credentials.getClient(Driver_phone_login_activity.this).getHintPickerIntent(hintRequest);
        try
        {
...
//otp callbacks
        callbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                Toast.makeText(Driver_phone_login_activity.this, "Something Went Wrong,Try Again", Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(@NonNull String verificationID,@NonNull PhoneAuthProvider.ForceResendingToken token){
                ...
                mResentToken=token;
                Toast.makeText(Driver_phone_login_activity.this, "6 Digit OTP Sent", Toast.LENGTH_SHORT).show();
    ...
    private void sendOtp() {
        ...
        PhoneAuthOptions options= PhoneAuthOptions.newBuilder(mAuth)
                ...
                .setActivity(Driver_phone_login_activity.this)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            Toast.makeText(Driver_phone_login_activity.this, "No Phone Numbers Found", Toast.LENGTH_LONG).show();
        }
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                      if (task.isSuccessful()){
                          Toast.makeText(Driver_phone_login_activity.this, "Logged In Successfully", Toast.LENGTH_SHORT).show();
                          Intent intent= new Intent(Driver_phone_login_activity.this, Driver_Map_Activity.class);
                          startActivity(intent);
                          finish();
                      }
                      else {
                          Toast.makeText(Driver_phone_login_activity.this, "Login Failed", Toast.LENGTH_SHORT).show();
                          Intent intent= new Intent(Driver_phone_login_activity.this, DriverLoginRegister_act.class);
                          startActivity(intent);
                          finish();
                      }
                    }
